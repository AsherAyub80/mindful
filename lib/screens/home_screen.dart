...
//       setState(() {
//         _meals = recs.map((m) => Meal.fromJson(m)).toList();
//         _aiIntent = data['intent'];
//       });
//     } catch (_) {
//       // Use mock data if backend not running
//       setState(
//           () => _meals = AppData.meals.where((m) => m.mood == mood).toList());
//     } finally {
...
//           .selectMood(AppData.moodLabels[i], i);
//       _moodCtrl.forward();
//       await _loadMeals();
//     });
//   }
...
//                                 "Nourishing meals selected for your ${moodState.mood} state."
...
//                     Text(AppData.moodEmojis[i],
//                         style: const TextStyle(fontSize: 14)),
//                     const SizedBox(width: 6),
//                     Text(AppData.moodLabels[i],
//                         style: TextStyle(
//                             fontSize: 13,
...
//             emoji: '🍳',
//             title: 'Cook at Home',
//             subtitle: 'Mindful recipes for your mood',
...
//             emoji: '🍽️',
//             title: 'Go Out',
//             subtitle: 'Restaurants matching your vibe',
...
//                                 SkeletonLoader(
//                                     width: 100, height: 11, borderRadius: 5),
//                               ]),
//                         ])),
//                       )))
//         else
...
//               ? [
//                   const Center(
//                       child: Text('No meals found for this mood',
//                           style: TextStyle(color: AppColors.white50)))
//                 ]
//               : _meals.map((m) => Padding(
//                     padding: const EdgeInsets.only(bottom: 12),
//                     child:
//                         _MealCard(meal: m, onTap: () => widget.onNavigate(1)),
//                   )),
//         const SizedBox(height: 20),
...
//         GlassCard(
//           gradient: const LinearGradient(
//               colors: [Color(0x2EF7C59F), Color(0x21FF8B6B)]),
//           backgroundColor: Colors.transparent,
//           child: Row(children: [
...
//               Text(
//                   '${ref.watch(authProvider).user?.streakCount ?? 0}-Day Streak!',
//                   style: const TextStyle(
//                       color: AppColors.gold,
//                       fontSize: 16,
//                       fontWeight: FontWeight.w700)),
//               const SizedBox(height: 2),
//               const Text("You're building incredible habits!",
...
//                         fontWeight: FontWeight.w700)),
//                 const SizedBox(height: 6),
//                 Text("You're feeling ${moodState.mood.toLowerCase()} today",
//                     style: const TextStyle(
//                         color: AppColors.white50, fontSize: 13)),
//                 const SizedBox(height: 24),
//                 Row(children: [
...
//                           emoji: '🍳',
//                           title: 'Cook at Home',
//                           subtitle: 'Mindful recipes tailored to your mood',
//                           color: AppColors.emerald,
//                           onTap: () {
...
//                     emoji: '🍽️',
//                     title: 'Go Out',
//                     subtitle: 'Restaurants matching your vibe nearby',
//                     color: AppColors.primary,
//                     highlighted: true,
//                     onTap: () {
//                       Navigator.pop(context);
...
//                           context,
//                           MaterialPageRoute(
//                               builder: (_) => RestaurantSuggestionsScreen(
//                                   mood: moodState.mood,
//                                   moodEmoji: AppData
//                                       .moodEmojis[moodState.moodIndex])));
//                     },
//                   )),
//                 ]),
//                 const SizedBox(height: 12),
...
//     _s = Tween<double>(begin: 1.0, end: 0.97).animate(_c);
//   }
...
//   Widget build(BuildContext context) {
//     final color =
//         meal.moodTags.isNotEmpty ? const Color(0xFF3DAA7A) : AppColors.primary;
//     return GestureDetector(
//       onTap: onTap,
//       child: ClipRRect(
...
//                       children: [
//                     if (meal.tag != null)
//                       GlassChip(label: meal.tag!, color: color),
//                     const SizedBox(height: 4),
//                     Text(meal.title,
//                         style: const TextStyle(
//                             color: Colors.white,
...
//                   child: Icon(Icons.chevron_right, color: AppColors.white20)),
//             ]),
//           ),
//           Positioned(
//               top: 0,
...
//   @override
//   State<_ModalOption> createState() => _ModalOptionState();
// }

// class _ModalOptionState extends State<_ModalOption>
//     with SingleTickerProviderStateMixin {
//   late AnimationController _c;
//   late Animation<double> _s;
//   @override
...
//                 ? [
//                     BoxShadow(
//                         color: widget.color.withOpacity(0.2), blurRadius: 20)
//                   ]
//                 : null,
//           ),
//           child:
...
//  _MealCard.onTap now sets selectedMealIdProvider BEFORE
//  calling onNavigate(1), so RecipeScreen knows which meal
//  to fetch from GET /v1/meals/:id
// ══════════════════════════════════════════════════════════════
...
//   /// Navigate to RecipeScreen with the selected meal ID
//   void _openRecipe(Meal meal) {
//     // Pass the real API id to RecipeScreen via the provider
...
//             color: AppColors.emerald,
//             onTap: () {
//               // Clear any previous selection so RecipeScreen shows mock
//               ref.read(selectedMealIdProvider.notifier).state = null;
//               widget.onNavigate(1);
//             },
//           )),
//           const SizedBox(width: 12),
...
//                         child: _MealCard(
//                           meal: m,
//                           // ← KEY CHANGE: pass real ID before navigating
//                           onTap: () => _openRecipe(m),
//                         ),
//                       ))
//                   .toList(),
...
//                 const SizedBox(height: 6),
//                 Text(
//                     "You're feeling ${moodState.mood.toLowerCase()} today",
//                     style: const TextStyle(
//                         color: AppColors.white50, fontSize: 13)),
//                 const SizedBox(height: 24),
//                 Row(children: [
...
//                           title: 'Cook at Home',
//                           subtitle:
//                               'Mindful recipes tailored to your mood',
//                           color: AppColors.emerald,
//                           onTap: () {
//                             Navigator.pop(context);
//                             ref
//                                 .read(selectedMealIdProvider.notifier)
//                                 .state = null;
//                             widget.onNavigate(1);
//                           })),
//                   const SizedBox(width: 12),
...
//                     title: 'Go Out',
//                     subtitle:
//                         'Restaurants matching your vibe nearby',
//                     color: AppColors.primary,
//                     highlighted: true,
//                     onTap: () {
//                       Navigator.pop(context);
...
//                 color: widget.color.withOpacity(0.15),
//                 border:
//                     Border.all(color: widget.color.withOpacity(0.35)),
//                 boxShadow: [
//                   BoxShadow(
...
//   @override
//   Widget build(BuildContext context) {
//     final color = meal.moodTags.isNotEmpty
//         ? const Color(0xFF3DAA7A)
//         : AppColors.primary;
//     return GestureDetector(
//       onTap: onTap,
//       child: ClipRRect(
            ...
            child: Row(children: [
              ...
              Expanded(
                ...
                if (meal.moodAlignment != null) ...[
                  const SizedBox(height: 3),
                  Text(meal.moodAlignment!,
                      style: const TextStyle(color: AppColors.mint, fontSize: 11, fontStyle: FontStyle.italic),
...
class _ModalOption extends StatefulWidget {
  ...
  const _ModalOption(
      {required this.emoji, required this.title, required this.subtitle,
       required this.color, required this.onTap, this.highlighted = false});
  @override
  State<_ModalOption> createState() => _ModalOptionState();
}
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
                ...
                width: widget.highlighted ? 1.5 : 1),
            boxShadow: widget.highlighted
                ? [BoxShadow(color: widget.color.withOpacity(0.2), blurRadius: 20)]
                : null,
          ),
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text(widget.emoji, style: const TextStyle(fontSize: 30)),
            ...
            const SizedBox(height: 4),
            Text(widget.subtitle,
                style: const TextStyle(color: AppColors.white50, fontSize: 11, height: 1.4)),
            const SizedBox(height: 12),
            Container(
              padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 5),
              decoration: BoxDecoration(
